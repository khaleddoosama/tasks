  ...
  return enabledDays
    .map((day) => {
      ...
      return (
        ...
        `<div style="display:flex;align-items:center;gap:3mm;"><span style="font-size:9pt;font-weight:700;white-space:nowrap;">ساعات النوم:</span><span style="flex:1;border-bottom:1.5px solid #bbb;height:5mm;font-size:8pt;padding:1mm 2mm;">${day.عدد_ساعات_النوم || ""}</span></div>` +
        `<div style="display:flex;align-items:center;gap:3mm;"><span style="font-size:9pt;font-weight:700;white-space:nowrap;">ساعات الهاتف:</span><span style="flex:1;border-bottom:1.5px solid #bbb;height:5mm;font-size:8pt;padding:1mm 2mm;">${day.عدد_ساعات_الهاتف || ""}</span></div></div></div>` +
